...
export const BankrollManager: React.FC<BankrollManagerProps> = ({ bankroll, onSetInitialBankroll }) => {
  ...
  return (
    <section className="bg-brand-bg-light p-6 rounded-xl border border-brand-border mb-12">
      ...
      <div className="mt-6 pt-4 border-t border-brand-border flex items-center justify-center gap-4">
          ...
          <div className="relative">
             <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-brand-text-secondary">$</span>
              <input
                ...
                className="w-48 bg-brand-bg-dark border border-brand-border rounded-lg py-2 pl-7 pr-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green outline-none"
              />
          </div>
